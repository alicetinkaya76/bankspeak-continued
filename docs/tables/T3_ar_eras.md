**Table 3 — Assembled Annual Report era means.** Unweighted mean of fiscal-year rates over the years present in each window; the token-weighted value is given beneath each cell in parentheses. Series: 76 fiscal years, 1947–2024, missing 2000, 2010.
